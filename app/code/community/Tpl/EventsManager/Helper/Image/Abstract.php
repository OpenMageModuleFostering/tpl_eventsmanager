 ...
 * @author      TPL
 */
abstract class Tpl_EventsManager_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return Tpl_EventsManager_Helper_Image_Abstract
     * @author TPL
     */
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Tpl_EventsManager_Helper_Image_Abstract)
     * @author TPL
     */
