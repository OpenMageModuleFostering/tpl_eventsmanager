 ...
 */
/**
 * Adminhtml invitation status attribute edit page main tab
 *
 * @category    Tpl
 * @package     Tpl_EventsManager
 * @author      TPL
 */
class Tpl_EventsManager_Block_Adminhtml_Invitationstatus_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    /**
     * Adding product form elements for editing attribute
     *
     * @access protected
     * @return Tpl_EventsManager_Block_Adminhtml_Invitationstatus_Attribute_Edit_Tab_Main
     * @author TPL
     */
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent('adminhtml_invitationstatus_attribute_types', array('response'=>$response));
        ...
        Mage::dispatchEvent(
            'tpl_eventsmanager_adminhtml_invitationstatus_attribute_edit_prepare_form',
            array(
                'form'      => $form,
