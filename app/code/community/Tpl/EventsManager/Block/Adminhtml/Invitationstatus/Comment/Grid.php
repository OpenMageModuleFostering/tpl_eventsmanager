 ...
 */
/**
 * Invitation Status comments admin grid block
 *
 * @category    Tpl
 * @package     Tpl_EventsManager
 * @author      TPL
 */
class Tpl_EventsManager_Block_Adminhtml_Invitationstatus_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
    ...
    {
        parent::__construct();
        $this->setId('invitationstatusCommentGrid');
     ...
     *
     * @access protected
     * @return Tpl_EventsManager_Block_Adminhtml_Invitationstatus_Comment_Grid
     * @author TPL
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('tpl_eventsmanager/invitationstatus_comment_invitationstatus_collection');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'type'          => 'options',
                'options'       => array(
                    Tpl_EventsManager_Model_Invitationstatus_Comment::STATUS_PENDING  =>
                        Mage::helper('tpl_eventsmanager')->__('Pending'),
                    Tpl_EventsManager_Model_Invitationstatus_Comment::STATUS_APPROVED =>
                        Mage::helper('tpl_eventsmanager')->__('Approved'),
                    Tpl_EventsManager_Model_Invitationstatus_Comment::STATUS_REJECTED =>
     ...
     *
     * @access public
     * @param Tpl_EventsManager_Model_Invitationstatus_Comment
     * @return string
     * @author TPL
     */
     ...
     *
     * @access protected
     * @param Tpl_EventsManager_Model_Resource_Invitationstatus_Comment_Collection $collection
