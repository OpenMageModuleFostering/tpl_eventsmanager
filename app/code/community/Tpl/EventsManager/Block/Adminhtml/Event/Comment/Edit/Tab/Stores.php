 ...
 * @author      TPL
 */
class Tpl_EventsManager_Block_Adminhtml_Event_Comment_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Tpl_EventsManager_Block_Adminhtml_Event_Comment_Edit_Tab_Stores
     * @author TPL
     */
