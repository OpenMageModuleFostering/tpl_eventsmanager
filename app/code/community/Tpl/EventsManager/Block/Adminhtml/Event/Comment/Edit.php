 ...
 */
/**
 * Event comment admin edit form
 *
 * @category    Tpl
 * @package     Tpl_EventsManager
 * @author      TPL
 */
class Tpl_EventsManager_Block_Adminhtml_Event_Comment_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function __construct()
    {
        ...
        $this->_updateButton(
            'save',
            'label',
            Mage::helper('tpl_eventsmanager')->__('Save Event comment')
        );
        $this->_updateButton(
            'delete',
            'label',
            Mage::helper('tpl_eventsmanager')->__('Delete Event comment')
        );
        $this->_addButton(
            'saveandcontinue',
            array(
