 ...
 * @author      TPL
 */
class Tpl_EventsManager_Model_Event_Comment extends Mage_Core_Model_Abstract
{
     ...
     */
    const ENTITY    = 'tpl_eventsmanager_event_comment';
    const CACHE_TAG = 'tpl_eventsmanager_event_comment';
    /**
     * Prefix of model events names
     * @var string
     */
    protected $_eventPrefix = 'tpl_eventsmanager_event_comment';
