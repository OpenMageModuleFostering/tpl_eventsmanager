 ...
 * @author      TPL
 */
class Tpl_EventsManager_Model_Resource_Event extends Mage_Catalog_Model_Resource_Abstract
{
    protected $_eventProductTable = null;
    ...
    public function __construct()
    {
        ...
        $this->setType('tpl_eventsmanager_event')
            ->setConnection(
                $resource->getConnection('event_read'),
                $resource->getConnection('event_write')
            );
        $this->_eventProductTable = $this->getTable('tpl_eventsmanager/event_product');
    ...
    {
        $urlRewrite = Mage::getModel('eav/config')->getAttribute('tpl_eventsmanager_event', 'url_key');
