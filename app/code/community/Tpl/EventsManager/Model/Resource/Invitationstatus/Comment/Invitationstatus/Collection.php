 ...
 */
/**
 * Invitation Status comments resource collection model
 *
 * @category    Tpl
 * @package     Tpl_EventsManager
 * @author      TPL
 */
class Tpl_EventsManager_Model_Resource_Invitationstatus_Comment_Invitationstatus_Collection extends Tpl_EventsManager_Model_Resource_Invitationstatus_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('tpl_eventsmanager/invitationstatus_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.invitationstatus_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('tpl_eventsmanager/invitationstatus_comment');
        $this->addAttributeToSelect('event_name');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.invitationstatus_id = e.entity_id',
            array(
                'ct_title'      => 'title',
