 ...
 */
/**
 * Event comments resource collection model
 *
 * @category    Tpl
 * @package     Tpl_EventsManager
 * @author      TPL
 */
class Tpl_EventsManager_Model_Resource_Event_Comment_Event_Collection extends Tpl_EventsManager_Model_Resource_Event_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('tpl_eventsmanager/event_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.event_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('tpl_eventsmanager/event_comment');
        $this->addAttributeToSelect('event_name');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.event_id = e.entity_id',
            array(
                'ct_title'      => 'title',
