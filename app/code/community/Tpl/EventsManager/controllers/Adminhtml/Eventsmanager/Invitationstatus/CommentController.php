 ...
 * @author      TPL
 */
class Tpl_EventsManager_Adminhtml_Eventsmanager_Invitationstatus_CommentController extends Mage_Adminhtml_Controller_Action
{
    /**
     * init the comment
     *
    ...
    protected function _initComment()
    {
        ...
        $comment    = Mage::getModel('tpl_eventsmanager/invitationstatus_comment');
        if ($commentId) {
    ...
    public function indexAction()
    {
        ...
        $this->_title(Mage::helper('tpl_eventsmanager')->__('Events Manager'))
             ->_title(Mage::helper('tpl_eventsmanager')->__('Invitations Status'))
    ...
    public function editAction()
    {
        ...
        $invitationstatus = Mage::getModel('tpl_eventsmanager/invitationstatus')->load($comment->getInvitationstatusId());
    ...
    public function massStatusAction()
    {
        ...
        if (!is_array($commentIds)) {
            ...
            try {
                foreach ($commentIds as $commentId) {
                    $comment = Mage::getSingleton('tpl_eventsmanager/invitationstatus_comment')->load($commentId)
    ...
    {
        $fileName   = 'invitationstatus_comments.csv';
        $content    = $this->getLayout()->createBlock(
            'tpl_eventsmanager/adminhtml_invitationstatus_comment_grid'
        )
        ->getCsv();
    ...
    {
        $fileName   = 'invitationstatus_comments.xls';
        $content    = $this->getLayout()->createBlock(
            'tpl_eventsmanager/adminhtml_invitationstatus_comment_grid'
        )
        ->getExcelFile();
    ...
    {
        $fileName   = 'invitationstatus_comments.xml';
        $content    = $this->getLayout()->createBlock(
            'tpl_eventsmanager/adminhtml_invitationstatus_comment_grid'
        )
        ->getXml();
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('tpl_eventsmanager/invitationstatus_comments');
    }
}
